              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      <p className="text-2xl font-bold">{(Number(selectedDriver?.avgRating) || 0).toFixed(1)} ⭐</p>
                      <p className="text-sm text-muted-foreground">متوسط التقييم</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold">{(Number(selectedDriver?.totalEarnings) || 0).toFixed(2)}</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-green-600">
                        {(Number(selectedDriver?.walletBalance) || 0).toFixed(2)} ريال
                      </span>
                    </div>
