    ...
    const connect = () => {
      ...
      ws.onmessage = (e) => {
        try {
          ...
          if (['order_update', 'new_order', 'new_order_available', 'wasalni_created', 'order_status_changed', 'new_wasalni_request', 'NEW_NOTIFICATION', 'settings_changed', 'order_claimed'].includes(msg.type)) {
  ...
  return (
    <div className="space-y-8 p-4 md:p-8" dir="rtl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <Button
          onClick={() => setLocation('/admin/user-guide')}
          className="bg-blue-600 hover:bg-blue-700 text-white font-bold gap-2 shadow-md w-fit"
        >
          <BookOpen className="h-4 w-4" />
          دليل استخدام النظام PDF
        </Button>
      </div>
