    ...
    const connect = () => {
      ...
      ws.onmessage = (e) => {
        try {
          ...
          if (['order_update', 'new_order', 'new_order_available', 'wasalni_created', 'order_status_changed', 'new_wasalni_request', 'NEW_NOTIFICATION', 'settings_changed'].includes(msg.type)) {
